...
bb8:                                              ; preds = %bb7
  %r117 = load i32, ptr %r111, align 4
  %r116 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r117
...
bb9:                                              ; preds = %bb7
  ...
  %r124 = load i32, ptr %r120, align 4
  %r123 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r124
...
bb11:                                             ; preds = %bb10
  ...
  %r131 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r132
  %r133 = load i32, ptr %r131, align 4
...
bb13:                                             ; preds = %bb11
  ...
  %r139 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r140
...
bb17:                                             ; preds = %bb16
  ...
  %r153 = load i32, ptr %r120, align 4
  %r152 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r153
  %r154 = load i32, ptr %r152, align 4
  %r155 = icmp ne i32 %r154, 0
  br i1 %r155, label %bb19, label %bb20

bb19:                                             ; preds = %bb17
  %r157 = load i32, ptr %r111, align 4
  %r156 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r157
  store i32 1, ptr %r156, align 4
  br label %bb21

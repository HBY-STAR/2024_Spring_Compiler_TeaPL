...
bb2:                                              ; preds = %bb1
  ...
  %r121 = load i32, ptr %r114, align 4
  %r120 = getelementptr [4 x i32], ptr %r113, i32 0, i32 %r121
  store i32 %r119, ptr %r120, align 4
...
bb9:                                              ; preds = %main
  ...
  %r145 = load i32, ptr %r139, align 4

...
bb1:                                              ; preds = %bb2, %split
  ...
  %r119 = icmp ne i32 %r117, -1
  br i1 %r119, label %bb2, label %bb3

bb2:                                              ; preds = %bb1
  %r120 = load i32, ptr %r112, align 4
  %r121 = call i32 @mod(i32 %r120, i32 10)
  %r123 = load i32, ptr %r114, align 4
  %r122 = getelementptr [4 x i32], ptr %r113, i32 0, i32 %r123
  store i32 %r121, ptr %r122, align 4
...
bb5:                                              ; preds = %bb4
  %r137 = load i32, ptr %r128, align 4
  %r136 = getelementptr [4 x i32], ptr %r130, i32 0, i32 %r137
  %r138 = load i32, ptr %r136, align 4

...
baz:
  ...
  %r107 = getelementptr [10 x %Node], ptr %r105, i32 0, i32 2
  %r108 = getelementptr i32, ptr %r107, i32 0
  store i32 %r106, ptr %r108, align 4
  %r109 = call i32 @getint()
  %r110 = getelementptr [10 x %Node], ptr %r105, i32 0, i32 2
  %r111 = getelementptr i32, ptr %r110, i32 1

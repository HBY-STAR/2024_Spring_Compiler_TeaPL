...
bb2:                                              ; preds = %bb1
  ...
  %r107 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r108
...
bb4:                                              ; preds = %bb10, %bb3
  ...
  %r124 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r125
  %r126 = load i32, ptr %r124, align 4
...
bb5:                                              ; preds = %bb7
  ...
  %r138 = load i32, ptr %r114, align 4
  %r137 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r138
...
bb6:                                              ; preds = %bb7, %bb4
  ...
  %r147 = load i32, ptr %r114, align 4
  %r146 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r147
  %r148 = load i32, ptr %r146, align 4

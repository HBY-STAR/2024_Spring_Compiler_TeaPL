...
swap:
  ...
  %r106 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r107
  %r108 = load i32, ptr %r106, align 4
  store i32 %r108, ptr %r105, align 4
  %r110 = load i32, ptr %r104, align 4
  %r109 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r110
  %r111 = load i32, ptr %r109, align 4
  %r113 = load i32, ptr %r102, align 4
  %r112 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r113
  store i32 %r111, ptr %r112, align 4
  %r114 = load i32, ptr %r105, align 4
  %r116 = load i32, ptr %r104, align 4
  %r115 = getelementptr [10 x i32], ptr %r100, i32 0, i32 %r116
...
bb2:                                              ; preds = %bb1
  ...
  br i1 %r138, label %bb7, label %bb5

bb7:                                              ; preds = %bb2
  %r140 = load i32, ptr %r124, align 4
  %r139 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r140
  %r141 = load i32, ptr %r139, align 4
  %r143 = load i32, ptr %r132, align 4
  %r142 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r143
  %r144 = load i32, ptr %r142, align 4
  %r145 = icmp slt i32 %r141, %r144
  br i1 %r145, label %bb4, label %bb5
...
bb6:                                              ; preds = %bb5, %bb4
  ...
  %r148 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r149
  %r150 = load i32, ptr %r148, align 4
  %r152 = load i32, ptr %r124, align 4
  %r151 = getelementptr [10 x i32], ptr %r117, i32 0, i32 %r152
  %r153 = load i32, ptr %r151, align 4
  %r154 = icmp sgt i32 %r150, %r153
  br i1 %r154, label %bb8, label %bb9
...
bb11:                                             ; preds = %bb12, %heap_sort
  ...
  %r172 = icmp sgt i32 %r170, -1
  br i1 %r172, label %bb12, label %bb13
...
bb14:                                             ; preds = %bb15, %bb13
  ...
  br i1 %r183, label %bb15, label %bb16
...
bb18:                                             ; preds = %bb17
  %r214 = load i32, ptr %r206, align 4
  %r213 = getelementptr [10 x i32], ptr %r195, i32 0, i32 %r214
  ...
  %r218 = load i32, ptr %r206, align 4
  %r219 = add i32 %r218, 1
  store i32 %r219, ptr %r206, align 4
  br label %bb17

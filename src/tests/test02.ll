...
baz:
  ...
  %r107 = getelementptr [10 x %Node ], [10 x %Node ]* %r105, i32 0, i32 2
  %r108 = getelementptr i32, i32* %r107, i32 0
  store i32 %r106, i32* %r108
  %r109 = call i32 @getint()
  %r110 = getelementptr [10 x %Node ], [10 x %Node ]* %r105, i32 0, i32 2
...
main:
  ...
  %r126 = getelementptr i32, i32* %r125, i32 0
  %r127 = load i32, i32* %r126
  %r128 = getelementptr [10 x %Node ], [10 x %Node ]* @e, i32 0, i32 2
  %r129 = getelementptr i32, i32* %r128, i32 1

...
swap:
  ...
  %r106 = getelementptr [10 x i32 ], [10 x i32 ]* %r100, i32 0, i32 %r107
  %r108 = load i32, i32* %r106
  store i32 %r108, i32* %r105
  %r110 = load i32, i32* %r104
  %r109 = getelementptr [10 x i32 ], [10 x i32 ]* %r100, i32 0, i32 %r110
  %r111 = load i32, i32* %r109
  %r113 = load i32, i32* %r102
  %r112 = getelementptr [10 x i32 ], [10 x i32 ]* %r100, i32 0, i32 %r113
  store i32 %r111, i32* %r112
  %r114 = load i32, i32* %r105
  %r116 = load i32, i32* %r104
  %r115 = getelementptr [10 x i32 ], [10 x i32 ]* %r100, i32 0, i32 %r116
...
bb7:
  ...
  %r139 = getelementptr [10 x i32 ], [10 x i32 ]* %r117, i32 0, i32 %r140
  %r141 = load i32, i32* %r139
  %r143 = load i32, i32* %r132
  %r142 = getelementptr [10 x i32 ], [10 x i32 ]* %r117, i32 0, i32 %r143
...
bb6:
  ...
  %r148 = getelementptr [10 x i32 ], [10 x i32 ]* %r117, i32 0, i32 %r149
  %r150 = load i32, i32* %r148
  %r152 = load i32, i32* %r124
  %r151 = getelementptr [10 x i32 ], [10 x i32 ]* %r117, i32 0, i32 %r152
...
bb18:
  %r214 = load i32, i32* %r206
  %r213 = getelementptr [10 x i32 ], [10 x i32 ]* %r195, i32 0, i32 %r214
  %r215 = load i32, i32* %r213
  ...
  %r218 = load i32, i32* %r206
  %r219 = add i32 %r218, 1
  store i32 %r219, i32* %r206
  br label %bb17
